...
BEGIN
	DECLARE bYear INT; -- 변수선언 (저장 프로시저 내부에서 선언 및 사용)
...
BEGIN
	...
	DECLARE CONTINUE HANDLER FOR 1146 SELECT '테이블이 존재하지 않아요' as '오류메세지';
    SELECT * FROM notable;  -- 예외 발생하는 문장
END&&
DELIMITER ;
