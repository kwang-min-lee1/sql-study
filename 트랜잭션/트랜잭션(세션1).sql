...
CREATE TABLE transaction_log (
	...
	from_account INT,                                  -- 보낸 계좌
	to_account INT,                                    -- 받은 계좌
    amount BIGINT,
...
INSERT INTO transaction_log (from_account, to_account, amount)
    ...
    (SELECT account_id FROM accounts WHERE account_name ='전우치'),  -- 받는사람
    50000);  -- 금액
...
-- 첫번쨰 거래내역(중간점) 까지 확정 (두번째 거래내역은 반영안됨)
COMMIT;
