-- 문제 1: 'report_user'라는 사용자를 생성하고, 'sakila' 데이터베이스에 대한 SELECT 권한만 부여하세요. 
...
-- 문제 3: 'dev_user'라는 사용자를 생성하고, 사용자에게 'sakila' 데이터베이스의 'actor' 테이블에 대한 SELECT, INSERT, UPDATE 권한을 부여하세요. 이 사용자는 개발자 역할을 수행하며, 'actor' 테이블의 데이터를 조회하고 수정할 수 있어야 합니다.
